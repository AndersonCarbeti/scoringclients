Voici une version améliorée, plus claire, uniforme et prête pour README.md, avec une hiérarchie nette et des sections bien formatées pour la soutenance :
...
Vérifier le service et le modèle
